...
def ETD1(u, dt, eigen_B, A_xx, A_yy, D_xx, D_yy, dx, dy, Linear, RHS, c, Gamma, Leja_X, tol):
    ...
    u_linear = mu_mode_Leja(u, dt, eigen_B, A_xx, A_yy, D_xx, D_yy, dx, dy)
...
def ETDRK2(u, dt, eigen_B, A_xx, A_yy, D_xx, D_yy, dx, dy, Linear, RHS, c, Gamma, Leja_X, tol):
    ...
    F_u = (RHS(u) - Linear(u))
    u_nonlin_1, rhs_phi_1, conv = real_Leja_phi(u, dt, Linear, F_u*dt, c, Gamma, Leja_X, phi_1, tol)
    
    a = u_linear + u_nonlin_1
    
    F_a = (RHS(a) - Linear(a))
    u_nonlin_2, rhs_phi_2, conv = real_Leja_phi(u, dt, Linear, (F_a - F_u)*dt, c, Gamma, Leja_X, phi_2, tol)
